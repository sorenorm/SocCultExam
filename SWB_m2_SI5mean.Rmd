...
for(i in rounds){
  for(j in 1:n_agents){
    ...
    if(i > 6) {
      agent$swb5[i] = sum(agent$swb[(i-4):i], na.rm = T)/5
      agent$pp5[i] = sum(ifelse(agent$pp[(i-4):i] == 0, 0, 1), na.rm = T)/5
      agent$w5[i] = sum(agent$wealth[(i-4):i], na.rm = T)/5
    }
  ...
  for(k in 1:(n_agents/2)){
    ...
    if (agent1$pp5[i] + agent2$pp5[i] == 0) {
      perc1 <-
        ...
        (0.5 * ((agent1$w5[i] - agent2$w5[i]) / mean(agent1$w5[i] + agent2$w5[i])) +
          0.5 * 1)
      
      perc2 <-
        (1 - agent2$materialism[i]) * (agent2$swb5[i] - agent1$swb5[i]) +
        agent2$materialism[i] *
        (0.5 * ((agent2$w5[i] - agent1$w5[i]) / mean(agent2$w5[i] + agent1$w5[i])) + 
           0.5 * 1)
      ...
      perc1 <-
        ...
        agent1$materialism[i] *
        (0.5 * ((agent1$w5[i] - agent2$w5[i]) / mean(agent1$w5[i] + agent2$w5[i])) +
          0.5 * ((agent1$pp5[i] - agent2$pp5[i]) / mean(agent1$pp5[i] + agent2$pp5[i])))
      ...
      perc2 <-
        ...
        (0.5 * ((agent2$w5[i] - agent1$w5[i]) / mean(agent2$w5[i] + agent1$w5[i])
          ...
          0.5 * ((agent2$pp5[i] - agent1$pp5[i]) / mean(agent2$pp5[i] + agent1$pp5[i])))
